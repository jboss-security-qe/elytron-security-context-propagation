...
# compile this project and place the deployments to server1 and server2
mvn clean install \
  && cp web/target/seccontext-web.war ejb-entrybean/target/seccontext-entry.jar $JBOSS_HOME/standalone1/deployments \
  && cp web/target/seccontext-web.war ejb-whoamibean/target/seccontext-whoami.jar $JBOSS_HOME/standalone2/deployments
